export class WeatherObj {
    constructor(Currenttemp_f, Currenttemp_c, CurrentCondition, LocationName, LocationRegion, LocationCountry, feelslike_c, feelslike_f, humidity, wind_mph, wind_kph, vis_miles, vis_km,date) {
